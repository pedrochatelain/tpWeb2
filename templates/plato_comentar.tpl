...
<form id="form_comment" class="form_comment container" method="post" action="comentar/{$plato->id_plato}">
    ...
    <div class="select_puntuacion_form_comment">
        <select name="puntuacion" class="btn btn-primary add_comment_button">
    ...
    <div class="btn_comentar_form_comment">
        <input type="submit" value="Post" class="btn btn-primary btn-lg btn-block add_comment_button">
    </div>
</div>
</form>
{/if}