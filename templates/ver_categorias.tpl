            ...
            <table>
                ...
                <tbody id="tabla">
                    ...
                    <tr class = 'tabla_categorias'>
                        ...
                        <td>
                            <a href="categorias/{$categoria->id_categoria}"><input class="btn btn-outline-light" value="Detalle" type="button">
                        </td>
                        {if $userAdmin == 1}
                            <td>
                                <a class="btn_borrar btn btn-outline-light" role="button" href='categorias/borrar/{$categoria->id_categoria}'>Borrar</a>
                            </td>
                        {/if}
                    </tr>
                    <input type="number" class="d-none" name='id_categoria[]' value='{$categoria->id_categoria}'>
                    {/foreach}
