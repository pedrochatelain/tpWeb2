    ...
    <div class="container">
        ...
        <form id= "form_editar" action="categorias/editar" method="post" autocomplete="off">
            <table>
                <thead>
                    <tr>
                        <th>Tipo</th>
                ...
                <tbody id="tabla">
                    <tr class = 'tabla_categorias'>
                        ...
                        {if $userAdmin == 1}
                            ...
                            <td> <a class="btn_borrar btn btn-outline-light" role="button" href='categorias/borrar/{$categoria->id_categoria}'>Borrar</a></td>
                        {/if}
                    </tr>
